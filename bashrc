...
#shopt -s checkwinsize # this has weord behavior
...
# shopt -s histappend # this has weird behavior
...
if [[ $PS1 && -f /usr/share/git/git-prompt.sh ]]; then
    ...
    if ${use_color} ; then
        PS1='\[\e[1;94m\][\[\e[m\]'                     # [
        PS1+='\[\e[1;92m\]\u\[\e[m\]'                   # user
        PS1+='\[\e[1;94m\]@\[\e[m\]'                    # @
        PS1+='\[\e[1;92m\]\h\[\e[m\]'                   # host
        PS1+=' \[\e[1;93m\]\W\[\e[m\]'                  # PWD
        PS1+='\[\e[1;94m\]]\[\e[m\]'                    # ]
        PS1+='\[\e[1;91m\]$(__git_ps1 "(%s)")\[\e[m\]'  # git stuff
        PS1+='\[\e[1;92m\]\$\[\e[m\] '                  # $/#
        PS1+='\[\e[0;37m\]'                             # reset color to regular white
    else
